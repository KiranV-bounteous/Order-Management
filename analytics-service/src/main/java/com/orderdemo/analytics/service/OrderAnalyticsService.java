package com.orderdemo.analytics.service;

import com.orderdemo.analytics.client.OrderServiceClient;
...
public class OrderAnalyticsService {
    ...
    @Autowired
    public OrderAnalyticsService(OrderServiceClient orderServiceClient) {
    ...
    public OrderAnalyticsDTO getAnalytics() {
        List<Order> allOrders = orderServiceClient.getAllOrders();
